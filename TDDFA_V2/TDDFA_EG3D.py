...
class TDDFA(object):
    ...
    def __init__(self, **kvs):
        ...
        # load BFM
        self.bfm = BFMModel(
            bfm_fp=kvs.get('bfm_fp', './TDDFA_V2/configs/bfm_noneck_v3.pkl'),
        ...
        param_mean_std_fp = kvs.get(
            'param_mean_std_fp', f'./TDDFA_V2/configs/param_mean_std_62d_{self.size}x{self.size}.pkl'
        )
    ...
    def recon_vers(self, param_lst, roi_box_lst, **kvs):
        ...
        for param, roi_box in zip(param_lst, roi_box_lst):
            ...
            facial_shape = (self.bfm.u + self.bfm.w_shp @ alpha_shp + self.bfm.w_exp @ alpha_exp).reshape(3, -1, order='F')
            shape_lst.append(facial_shape)
        return shape_lst

    def render_params(self, param_lst, roi_box_lst, **kvs):
        size = self.size
        R_lst, offset_lst = [], []
        for param, roi_box in zip(param_lst, roi_box_lst):
            R, offset, alpha_shp, alpha_exp = _parse_param(param)
        ...
        return R_lst, offset_lst, roi_box_lst, size
